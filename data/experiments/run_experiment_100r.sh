#!/usr/bin/env bash
# ACEA paper experiment v2 — one 100-ROUND battle per config, DEFAULT red/blue.
...
OUT=/Users/yiting.shen/Documents/project/ACEA/data/experiments
PROG=$OUT/progress_100r.log

ts() { date '+%F %T'; }
log() { echo "$(ts) $*" >> "$PROG"; }

log "=== experiment v2 start (100-round, default red/blue, 3x10 benchmark) ==="
