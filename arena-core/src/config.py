...
class Settings(BaseSettings):
    ...
    # comprehension. Falls back to meta_agent/analyzer models if unset.
    red_recon_model: str = ""
    blue_recon_model: str = ""
    meta_optimizer_model: str = ""
    # Additional models added by ASIS / evolution / report-composer services
    meta_agent_model: str = ""   # code-improver
    ...
    code_improver_url: str = "http://code-improver:8010"
    ...
    improvement_per_round: bool = True
    ...
    # unreachable (no ASIS rebuild in progress) for `disconnect_reconnect_window`
