...
const RED_ROLES: ChatRole[] = ['recon', 'strategy', 'rewriter', 'attack', 'judge']
const BLUE_ROLES: ChatRole[] = ['recon', 'strategy', 'enhancer', 'defense', 'judge']

const RED_IDLE = 'No active battle. Launch one to watch the red side\'s roles think in real time — Recon reads the connected project, Strategy diagnoses, the Rewriter turns it into the next move, and the Arbiter scores.'
const BLUE_IDLE = 'No active battle. Launch one to watch the blue side\'s roles think in real time — Recon reads the connected project, Strategy diagnoses gaps, the Defense Enhancer proposes tightening, and the Arbiter scores.'
