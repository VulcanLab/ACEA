...
export type ChatRole =
  ...
  | 'attack' | 'defense' | 'judge' | 'asis' | 'target' | 'system'
...
export type AgentEvent =
  ...
  /** ASIS code-improver events — persistent code evolution signals */
  | { type: 'asis_update'; team: 'red' | 'blue'; status: 'improving' | 'promoted' | 'rolled_back' | 'no_change'; gen: number; message: string }
  /** ASIS real work-phase signal (analyzing → editing → building → benchmarking) — drives the live evolver visual */
  | { type: 'asis_phase'; team: 'red' | 'blue'; phase: 'analyzing' | 'editing' | 'building' | 'benchmarking'; gen: number; message: string }
